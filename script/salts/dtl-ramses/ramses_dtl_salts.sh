...
# Usage:
# ./ramses_dtl_salts.sh --deployFile <path> --envFile <.env>
#
...
forge script ./script/salts/dtl-ramses/RamsesDTLSalts.s.sol:RamsesDTLSalts --sig "generate(string,string)()" $CHAIN $DEPLOY_FILE
