...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
        ...
        unchecked {
            ...
            if (paid0 > 0) {
                ...
                feeGrowthGlobal0X128 +=
                    FullMath.mulDiv(paid0 - pFees0, FixedPoint128.Q128, _liquidity);
            }
            if (paid1 > 0) {
                ...
                feeGrowthGlobal1X128 +=
                    FullMath.mulDiv(paid1 - pFees1, FixedPoint128.Q128, _liquidity);
            }
    ...
    function setFeeProtocol(
        ...
        unchecked {
            ...
            emit SetFeeProtocol(
                feeProtocolOld % 16, feeProtocolOld >> 4, feeProtocol0, feeProtocol1
            );
        }
    }
